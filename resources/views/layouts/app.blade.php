            ...
            <div id="nav-top" class="border-b border-gradient border-gradient-blue">
                <div class="container d-flex justify-content-between flex-wrap align-items-center">
                    <div id="first-nav-container">
                        <a id="youtube-svg-container" href="{{ route('home') }}" class="let-main-logo">
                            <img style="width: auto;height: 45px;text-align: left;position: absolute;left: 50%;top: 50%;transform: translate(-50%, -50%);" src="{{ asset('/images/logo-1.png') }}" alt="logo">
                        </a>
                    ...
                    <div class="menu-tutorial-wrapper d-flex justify-content-around">
							<!--<div class="top-user">
								<div class="user-icon">
									<a href="https://neospide.techhelpinfotech.com/public/user-menu"><img src="/images/avtar.png" alt="profile-icon"></a>
								</div>
							</div>-->
...
<script>
		document.addEventListener('DOMContentLoaded', function() {
            ...
            let fullText = joinedDateElement.textContent.trim();
            let dateMatch = fullText.match(/\d{4}-\d{2}-\d{2}/);
            if (dateMatch) {
                let dateComponents = dateMatch[0].split('-');
                const monthNames = [
                    "January", "February", "March", "April", "May", "June",
                    "July", "August", "September", "October", "November", "December"
                ];
                let monthName = monthNames[parseInt(dateComponents[1], 10) - 1];
                let formattedDate = dateComponents[2] + '-' + monthName + '-' + dateComponents[0];
